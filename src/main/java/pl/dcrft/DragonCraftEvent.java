...
public final class DragonCraftEvent extends JavaPlugin implements Listener, CommandExecutor {
    private static DragonCraftEvent instance;
    public static DragonCraftEvent getInstance() {
        return instance;
    }
    ...
    public void onEnable() {
        ...
        getLogger().info("§e§lDragon§6§lCraft§d§lEvent");
